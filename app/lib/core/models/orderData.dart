...
class OrderData {
  ...
  OrderData copyWith({
    ...
    return OrderData(
      ...
      courierNoteNumber: courierNoteNumber ?? this.courierNoteNumber,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'courierNoteNumber': courierNoteNumber,
    };
  }
  ...
  factory OrderData.fromMap(Map<String, dynamic> map) {
    ...
    return OrderData(
      ...
      courierNoteNumber: map['courierNoteNumber'],
    );
  }
  ...
  bool operator ==(Object o) {
    ...
    return o is OrderData &&
      ...
      o.refundId == refundId &&
      o.courierNoteNumber == courierNoteNumber &&
      o.subTotal == subTotal &&
      o.promo == promo &&
      o.shipping == shipping &&
